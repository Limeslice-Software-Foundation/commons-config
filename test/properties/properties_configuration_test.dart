...
void main() {
  ...
  test('Test load file', () {
    PropertiesConfiguration config = PropertiesConfiguration(file: File(testPropsFilename));
    config.load();
    bool expected = true;
  ...
  test('Test multi line value', () {
    String expected = "This is a value spread out across several adjacent natural lines by escaping the line terminator with a backslash character.";
