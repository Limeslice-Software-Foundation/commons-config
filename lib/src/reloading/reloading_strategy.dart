...
abstract class ReloadingStrategy {
  ...
  /// Create an invariant reloading strategy.
  static ReloadingStrategy inavriantReloadingStrategy() {
    return InavriantReloadingStrategy();
  }
}
...
class InavriantReloadingStrategy extends ReloadingStrategy {
  ...
  /// Check if reloading is required for the configuration.
  /// The <code>InavriantReloadingStrategy</code> always returns false.
  @override
  bool reloadingRequired() {
    return false;
  }
